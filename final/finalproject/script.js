...
(function () {
    ...
    const shield = new Audio('./audio/shield.mp3');
    ...
    startGame.addEventListener('click', function () {
        ...
        document.getElementById('quit').classList.add("button3h");
        document.getElementById('help').classList.add("button3h");
        switchPlayers();
    ...
    function checkWinningCondition() {
        ...
        if (gameData.score[gameData.enemy] <= 0) {
            ...
            if (gameData.index === 0) { // player1's turn is over
                player1.classList.add("gloweffect");
            } else { // player2's turn is over
                player2.classList.add("gloweffect");
            }
            // [gameData.index].classList.add("gloweffect");
            win.play();
        }
    }
